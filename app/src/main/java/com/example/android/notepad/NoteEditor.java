...
public class NoteEditor extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.changeback_menu, menu);
            ...
            case R.id.changeback:
                ...
                button_green.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#EEEED1"));
                        aDialog.dismiss();
                    }
                });
                /*变为蓝色背景*/
                Button button_blue = (Button) layout.findViewById(R.id.blue);
                button_blue.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#BFEFFF"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                Button button_yellow = (Button) layout.findViewById(R.id.yellow);
                button_yellow.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#FFFF00"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                Button button_qblue = (Button) layout.findViewById(R.id.qblue);
                button_qblue.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#00FFFF"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                Button button_pink = (Button) layout.findViewById(R.id.pink);
                button_pink.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        View note_edit = (View)findViewById(R.id.note);
                        note_edit.setBackgroundColor(Color.parseColor("#EED2EE"));
                        aDialog.dismiss();
                    }
                });
                break;
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        String re_StrTime = sdf.format(System.currentTimeMillis());
