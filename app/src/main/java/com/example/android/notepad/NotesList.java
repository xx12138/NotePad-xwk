...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // noteslist_item.xml
        int[] viewIDs = { android.R.id.text1, R.id.note_date};
...
//        else
//            haveItems = false;
//        Log.d("itemcount",haveItems + "" + mListView.getCount()  );
        ...
        switch (item.getItemId()) {
            ...
            case R.id.changeback:
                ...
                button_blue.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#BFEFFF"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                ...
                button_yellow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#FFFF00"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                ...
                button_qblue.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#00FFFF"));
                        aDialog.dismiss();
                    }
                });
                /*变为黄色背景*/
                ...
                button_pink.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        RelativeLayout note_list = (RelativeLayout)findViewById(R.id.noteLayout);
                        note_list.setBackgroundColor(Color.parseColor("#EED2EE"));
                        aDialog.dismiss();
                    }
                });
                return true;
